            ...
            <footer className="bg-gray-900 text-gray-300 pt-12">
                <div className="max-w-7xl mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 border-b border-gray-700">
                        {/* LOGO + DESC */}
                        <div>
                            <h2 className="text-2xl font-bold text-red-500 mb-3">🎬 TicketFilm</h2>
                            <p className="text-sm leading-relaxed">
                                Nền tảng đặt vé xem phim nhanh chóng, tiện lợi.
                                Trải nghiệm điện ảnh đỉnh cao tại các rạp trên toàn quốc.
                            </p>
                        </div>
                        {/* MENU */}
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><a href="#" className="hover:text-red-500 transition">Phim sắp chiếu</a></li>
                                <li><a href="#" className="hover:text-red-500 transition">Rạp &amp; Giá vé</a></li>
                                <li><a href="#" className="hover:text-red-500 transition">Khuyến mãi</a></li>
                            </ul>
                        </div>
                        {/* SUPPORT */}
                        <div>
                            ...
                            <ul className="space-y-2 text-sm">
                                ...
                                <li><a href="#" className="hover:text-red-500 transition">Điều khoản sử dụng</a></li>
                                <li><a href="#" className="hover:text-red-500 transition">Chính sách bảo mật</a></li>
                                <li><a href="#" className="hover:text-red-500 transition">Liên hệ</a></li>
                            </ul>
                        </div>
                        {/* CONTACT */}
                        <div>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center py-6 text-sm">
                        ...
                        <div className="flex space-x-4 mb-4 md:mb-0">
                            {/* Facebook */}
                            <a href="#" className="group w-10 h-10 flex items-center justify-center rounded-full 
      bg-blue-600 border border-blue-600 
      hover:opacity-50 hover:border-blue-600 transition-all duration-300">
                                <svg className="w-5 h-5 text-gray-50 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
